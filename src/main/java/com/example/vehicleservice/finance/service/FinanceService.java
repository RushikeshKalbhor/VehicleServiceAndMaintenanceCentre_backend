...
public class FinanceService {
    ...
    public ResponseJson editBill(AddBillJson addBillJson) {

        if (addBillJson.getBId() == null) {
        ...
        if (bill == null) {
            return new ResponseJson("finance.bill.edit.fail");
        }

        financeUtil.updateBill(addBillJson, bill);
